<?php
 ...
 //shortcode
  function smart_grid_product_shortcode($atts, $content = null){
    ob_start();
   ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                  <div class="sec-title style-two text-center">
                       ...
                       <h2 style="color: <?php echo esc_html( smart_grid_option('wp_grid', 'h_color')); ?>"><?php echo esc_html( smart_grid_option('wp_grid', 'header1')); ?></h2>
                        <p style="color: <?php echo esc_html( smart_grid_option('wp_grid', 'h_color')); ?>"><?php echo esc_html( smart_grid_option('wp_grid', 'header2') ); ?></p>
                    </div>
            ...
            <div class="row project-content masonary-layout filter-layout">
              <?php  
                  ...
                  'post_type' =>  'product',  
                  'posts_per_page'  => smart_grid_option('wp_grid', 'ppr')
                  )  );  
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 filter-item <?php foreach ($terms as $term) { echo strtolower(preg_replace('/[^a-zA-Z]+/', '-', $term->name)). ' '; } ?>">
                    <div class="item">
                        ...
                        <div class="grid-overlay">
                            ...
                            <a href="<?php the_permalink( ); ?>" class="title-overly"><h5 style="color: <?php echo esc_html( smart_grid_option('wp_grid', 't_color')); ?>;background: <?php echo esc_html( smart_grid_option('wp_grid', 'tb_color')); ?>"><?php the_title(); ?></h5></a>
                        </div>                    
                    </div>
                </div>
                <!--End single project-->
...
add_shortcode( 'smart_grid_product', 'smart_grid_product_shortcode');
